...
@section('body')
<div class="row my-3">
    <label class="col-sm-2 col-form-label text-end"><b class="text-danger">*</b> 真实姓名</label>
    <div class="col-sm-4">
...
<div class="row my-3">
    <label class="col-sm-2 col-form-label text-end"><b class="text-danger">*</b> 用户名</label>
    <div class="col-sm-4">
...
<div class="row my-3">
    <label class="col-sm-2 col-form-label text-end">@if(empty($item))<b class="text-danger">*</b>@endif 密码</label>
    <div class="col-sm-4">
...
<div class="row my-3">
    <label class="col-sm-2 col-form-label text-end"><b class="text-danger">*</b> 所在菜单组</label>
    <div class="col-sm-4">
