...
<div class="field-group clear">
    ...
    <div class="field-value">
        <input type="text" class="width100" name="power_item_group_id" id="single-power_item_group-id" placeholder="所在权限组ID" value="{{$item?$item->power_item_group_id:''}}" required="true" number="true" readonly="readonly"/>
        <input type="text" class="width200" placeholder="所在权限组名" id="single-power_item_group-name" value="{{$item?$item->group->name:''}}" disabled="disabled"/>
        <input type="button" onclick="open_window('{{crbac_route('power.item-group.select',['single'])}}');" value="选择组"/>
    </div>
</div>
